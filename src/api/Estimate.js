...
export const getEstimateDetail = async (estimateIdx) => {
  const data = await API.get(`estimate/${estimateIdx}`).then((res) => {
    return res.data;
  });
  return data;
};
...
export const confirmEstimate = async (estimateIdx, photographerIdx) => {
  const data = await API.put(
    `estimate/${estimateIdx}/confirmEstimate/photographer/${photographerIdx}`,
  ).then((res) => {
    return res.data;
  });
  return data;
...
export const confirmOrder = async (estimateIdx, photographerIdx) => {
  const data = await API.put(
    `estimate/${estimateIdx}/confirmOrder/photographer/${photographerIdx}`,
  ).then((res) => {
    return res.data;
  });
  return data;
...
export const applyEstimate = async (estimateIdx, photographerIdx) => {
  const data = await API.put(
    `estimate/${estimateIdx}/photographer/${photographerIdx}/apply`,
  ).then((res) => {
    return res.data;
  });
  return data;
...
export const deleteEstimate = async (estimateIdx) => {
  const data = await API.delete(`estimate/${estimateIdx}`).then((res) => {
    return res.data;
  });
  return data;
};
